...
/**
 * The echo client submits an "echo" job to a job server and prints the final result. It's the "Hello World" of the
 * java-geraman-service
 * 
...
public class EchoClientAsynchronous implements GearmanJobEventCallback<String>
{
    ...
    public static void main(String... args) throws InterruptedException
    {
        ...
        /*
         * Create the job server object. This call creates an object representing a remote job server.
         * 
         * Parameter 1: the host address of the job server. Parameter 2: the port number the job server is listening on.
         * 
        ...
        /*
         * Submit a job to a job server. This submit method uses an asynchronous callback object to process the job's
         * result
         * 
         * Parameter 1: the gearman function name Parameter 2: the data passed to the server and worker Parameter 3: an
         * attachment returned through the callback Parameter 4: the callback used to process the job events
         * 
         * The GearmanJoin object is used to block the current thread until the end-of-file has been reached.
         */
        GearmanJoin<String> join = client.submitJob(EchoWorker.ECHO_FUNCTION_NAME, ("Hello World").getBytes(),
         ...
         * 
         * It's suggested that you reuse Gearman and GearmanClient instances rather recreating and closing new ones
         * between submissions
         */
        gearman.shutdown();
    }
