...
public class EchoWorkerServer
{
    public static void main(String... args) throws IOException
    {
        ...
        try
        {
            ...
            /*
             * Start a new job server. The resulting server will be running in the local address space.
             * 
            ...
            // GearmanServer server = gearman.startGearmanServer

            /*
             * Create a gearman worker. The worker poll jobs from the server and executes the corresponding
             * GearmanFunction
             */
