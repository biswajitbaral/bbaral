...
public class EchoWorker implements GearmanFunction
{
   ...
   // public static final String ECHO_FUNCTION_NAME = "echo";
	public static final String ECHO_FUNCTION_NAME ="CONFIG_DIFF_WORKER";
    ...
    public static void main(String... args)
    {
        ...
        /*
         * Create a gearman worker. The worker poll jobs from the server and executes the corresponding GearmanFunction
         */
    ...
    public byte[] work(String function, byte[] data, GearmanFunctionCallback callback) throws Exception
    {
        ...
        /*
         * The work method performs the gearman function. In this case, the echo function simply returns the data it
         * received
         */
